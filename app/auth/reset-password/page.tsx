...
export default function AuthResetPasswordPage() {
  ...
  // Only sign out after successful password reset
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await signOut() // Sign out after password reset
      setTimeout(() => {
          ...
          <div className="">
            ...
            <form onSubmit={handlePasswordReset} className="space-y-4">
              ...
              >
                ...
                // TODO: Updating is persisting after password reset
                ) : success ? 'Submitted' : 'Update Password'}
              </button>
            </form>
