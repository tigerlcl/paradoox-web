      ...
      <main className="relative py-20">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          <div className="bg-slate-800/60 p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 rounded-2xl text-gray-300 text-base sm:text-lg leading-relaxed space-y-8 doc-content max-w-none">
            ...
            <p>
              Your privacy is important to us. It is Paradoox AI's policy to respect your privacy regarding any information we may collect from you across our website, <Link href="/">https://paradoox.ai</Link>, and other sites we own and operate.
            </p>
            ...
            <p>
              ...
              Paradoox AI Team
              <br />
              <Link href="mailto:support@paradoox.ai">support@paradoox.ai</Link>
            </p>
          </div>
        </div>
      </main>
