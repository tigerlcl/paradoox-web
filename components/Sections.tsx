      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          ...
          <div className="dark-card p-8 rounded-2xl hover:bg-gray-800/70 transition-all duration-300 group">
            ...
            <p className="text-gray-300 text-body leading-relaxed">
              Our core platform, DeepFund, is an <span className="text-yellow-400 font-medium">AI-powered financial twin system</span>. 
              It allows you to build, test, and deploy a team of AI analysts in a zero-risk environment. 
              We translate complex data into <span className="text-yellow-400 font-medium">clear logic</span>, showing you the 'why' behind every decision.
            </p>
          </div>
          ...
          <div className="dark-card p-8 rounded-2xl hover:bg-gray-800/70 transition-all duration-300 group">
            ...
            <p className="text-gray-300 text-body leading-relaxed">
              Fueling our ecosystem is InvestArena, a <span className="text-yellow-400 font-medium">community and leaderboard</span> for AI models. 
              Here, you can discover strategies built by other users, rate their performance, and even contribute your own, 
              fostering a <span className="text-yellow-400 font-medium">collaborative environment of innovation</span>.
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="dark-card p-8 rounded-2xl text-center hover:bg-gray-800/70 transition-all duration-300 group">
              <div className="w-20 h-20 bg-gradient-to-br from-yellow-500 to-yellow-400 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
                <i className="fas fa-user-cog text-black text-3xl"></i>
              </div>
              <h4 className="text-xl font-bold text-gray-100 mb-4 text-heading">Build Your AI Team Easily</h4>
              <p className="text-gray-300 text-body leading-relaxed">
                Build a <span className="text-yellow-400 font-medium">professional-grade AI investment team</span> with just a few clicks. 
            ...
            <div className="dark-card p-8 rounded-2xl text-center hover:bg-gray-800/70 transition-all duration-300 group">
              <div className="w-20 h-20 bg-gradient-to-br from-yellow-500 to-yellow-400 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
                <i className="fas fa-chart-line text-black text-3xl"></i>
              </div>
              <h4 className="text-xl font-bold text-gray-100 mb-4 text-heading">Analyze AI Performance</h4>
              <p className="text-gray-300 text-body leading-relaxed">
                Go beyond simple returns. Get <span className="text-yellow-400 font-medium">multi-dimensional performance reports</span> for every AI agent 
            ...
            <div className="dark-card p-8 rounded-2xl text-center hover:bg-gray-800/70 transition-all duration-300 group">
              <div className="w-20 h-20 bg-gradient-to-br from-yellow-500 to-yellow-400 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
                <i className="fas fa-globe text-black text-3xl"></i>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="dark-card p-8 rounded-2xl hover:bg-gray-700/70 transition-all duration-300 group">
            <div className="flex items-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-yellow-400 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <div>
                ...
                <span className="text-yellow-400 font-medium text-ui">Consumer-End (C-end)</span>
              </div>
            </div>
            <p className="text-gray-300 text-body leading-relaxed mb-6">
              If you are an investor looking to replace <span className="text-yellow-400 font-medium">guesswork with rational strategy</span>, 
              Paradoox AI is your risk-free sandbox. Understand the market, test your ideas, and learn the principles of 
              sound investing with an <span className="text-yellow-400 font-medium">AI guide by your side</span>.
            </p>
          ...
          <div className="dark-card p-8 rounded-2xl hover:bg-gray-700/70 transition-all duration-300 group">
            <div className="flex items-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-yellow-400 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                <i className="fas fa-building text-black text-2xl"></i>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-gray-100 text-heading">Financial Institutions & Advisors</h3>
                <span className="text-yellow-400 font-medium text-ui">Business-End (B-end)</span>
              </div>
            </div>
            <p className="text-gray-300 text-body leading-relaxed mb-6">
              For financial institutions, we offer a <span className="text-yellow-400 font-medium">powerful tool to enhance your advisory services</span>. 
              Our platform provides the personalized, explainable, and interactive experience that modern clients demand, 
              giving you a <span className="text-yellow-400 font-medium">competitive edge</span>.
            </p>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
